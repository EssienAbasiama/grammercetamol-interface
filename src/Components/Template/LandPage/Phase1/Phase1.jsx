      ...
      <div className={styles.clinic}>
        <div className={styles.clinic__}>
          ...
          {windowWidth <= breakpoint700 && windowWidth > breakpoint641 ? (
            <div className={styles.explain}>
              <p>
                SPEAK <span>ENGLISH</span> MORE NATURALLY WITH CONFIDENCE AND
                STUNNING <span>DICTION</span>
              </p>
            </div>
          ) : (
            <div className={styles.explain}>
              {windowWidth <= breakpoint641 ? (
                <p>
                  SPEAK <span>ENGLISH</span> MORE<br/> NATURALLY WITH
                  <br/> CONFIDENCE AND<br/>STUNNING <span>DICTION</span>
                </p>
              ) : (
                <p>
                  SPEAK <span>ENGLISH</span> MORE NATURALLY WITH <br />
                  CONFIDENCE AND STUNNING <span>DICTION</span>
                </p>
              )}
            </div>
          )}
          <div className={styles.title_text_container}>
            {windowWidth <= breakpoint700 && windowWidth > breakpoint641 ? (
              ...
              </p> : <p className={styles.title_text_container_p}>Discover the Secrets to fat fluency,boost your word power<br></br>
              and improve your pronunciation
            </p>}
              </>
